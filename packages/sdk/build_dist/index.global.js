...
(() => {
  ...
  function getCache(clientId) {
    try {
      ...
      if (cachedId !== clientId) return false;
...
`;
  ...
  // src/widget/handlers.ts
  var sendToWidget = (type, data) => {
